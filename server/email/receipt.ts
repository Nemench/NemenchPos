...
// Intl.NumberFormat, absolute image URLs resolved against the page's own
// origin) that doesn't exist in this process. This one reads settings
// directly from the DB and skips the logo image entirely (most email
// clients block remote images by default anyway, and this avoids needing
// this server to know its own public URL) — real receipt content
// (itemized list, VAT, total, payment method), just not a pixel match.
